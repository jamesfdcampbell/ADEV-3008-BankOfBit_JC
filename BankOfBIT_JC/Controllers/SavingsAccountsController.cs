...
namespace BankOfBIT_JC.Controllers
{
    public class SavingsAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BankAccountId,ClientId,AccountStateId,AccountNumber,Balance,DateCreated,Notes,SavingsServicesCharges")] SavingsAccount savingsAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BankAccountId,ClientId,AccountStateId,AccountNumber,Balance,DateCreated,Notes,SavingsServicesCharges")] SavingsAccount savingsAccount)
        {
            if (ModelState.IsValid)
            {
                savingsAccount.ChangeState();
